...
j17_flagged = extract.remove_bad(j17sour, multiplier=10, max_fl=30)

j08_sour = extract.isolate_sources(j2208, tname=flocs['j2208_template'], ignore='j2208_regionignore.csv')
j08_flag = extract.remove_bad(j08_sour, multiplier=10, max_fl=30)
...
#variability.light_curve(sources, 331.9553164560985, 55.58776007997343)
